...
| 1 1+| *Secure traffic to another external service (could be another ServiceMesh not managed with OSSM Federation)* 
...
| 2   1+| *Secure Traffic to an external service on another federated Service Mesh* 
