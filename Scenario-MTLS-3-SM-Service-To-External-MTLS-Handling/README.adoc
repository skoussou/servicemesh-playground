...
|    | <<option1aunencryptedpermissive, *Variation 1: Un-Encrypted* External Traffic via `sidecar` container with *PERMISSIVE* internal traffic>>| *Ready*

|    | <<option1aunencryptedstrict, *Variation 2: Un-Encrypted* External Traffic via `sidecar` container with *STRICT* internal traffic>>| *Ready*
