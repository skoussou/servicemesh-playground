...
oc apply -f https://raw.githubusercontent.com/skoussou/servicemesh-playground/main/Scenario-Observability-Scenarios/ISTIO-YAML/opentracing-with-jaeger-agent-sidecar-deployment.yaml -n test-jaeger-deployment-tracing
