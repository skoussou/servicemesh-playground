...
----
oc  new-project istio-production
...
* Deploy link:https://github.com/skoussou/servicemesh-playground/tree/main/Scenario-0-Deploy-In-ServiceMesh#opentracing-with-jaeger-agent-sidecar[`Opentracing with Jaeger Agent Sidecar`] Application for traces reporting
