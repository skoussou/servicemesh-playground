...
** Create and push image to quay.io (account is required) link:https://github.com/skoussou/servicemesh-playground/tree/main/Scenario-0-Deploy-In-ServiceMesh#create-container-image-and-push-to-quayio[following the instructions here]
+
----
